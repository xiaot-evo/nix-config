{ pkgs, ... }:
let
  # 本地扩展 — 从 GitHub raw 固定 commit 拉取，无本地拷贝
  notifySrc = pkgs.fetchurl {
    url = "https://raw.githubusercontent.com/earendil-works/pi/dd1c690f36de449fac9b24c8b3d113837eaf7cfb/packages/coding-agent/examples/extensions/notify.ts";
